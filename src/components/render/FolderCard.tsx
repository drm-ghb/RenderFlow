...
export default function FolderCard({ folder, projectId, roomId }: FolderCardProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`w-14 h-14 bg-gray-100 dark:bg-muted rounded-xl flex items-center justify-center mb-4 group-hover:bg-gray-200 dark:group-hover:bg-muted/80 transition-colors ${folder.pinned ? "mt-2" : ""}`}>
